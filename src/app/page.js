      ...
      {isLoggedIn ? (
        <div className="space-y-4">
          ...
          <div className="space-x-4">
            ...
            <button
              ...
              className="bg-gray-600 text-white px-6 py-3 rounded-md shadow hover:bg-gray-700"
            >
              Wyloguj się
            </button>
          </div>
        ...
        <div className="space-y-4">
          <button
            ...
            className="bg-red-600 text-white px-6 py-3 rounded-md shadow hover:bg-red-700 flex items-center justify-center mx-auto"
          >
          ...
          <p className="text-sm text-gray-500">
            Lub przejdź bezpośrednio do aplikacji
          </p>
          <Link
            href="/dashboard"
